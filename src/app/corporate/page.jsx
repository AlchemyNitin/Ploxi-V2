...
export default function CorporateLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-blue-50 to-indigo-50">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3 pl-4 border-l border-gray-300">
              ...
              />
              <div>
                <h1 className="text-xl font-bold text-gray-900">Ploxi Earth</h1>
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-10 items-center">
            ...
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                <Link
                  href="/corporate/register"
                  className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white bg-green-600 border border-transparent rounded-xl hover:bg-green-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
                >
            ...
            <div className="mt-12 lg:mt-0 lg:col-span-6 flex justify-center">
              <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8 w-full max-w-md space-y-6">
      ...
      {showAssessment && (
        <section ref={assessmentRef} className="relative px-4 py-12 sm:px-6 lg:px-8 bg-white border-t border-gray-200">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Configure Your ESG Assessment</h2>
            ...
            {isNavigating && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-xl p-8 max-w-sm w-full mx-4 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">Preparing Dashboard</h3>
                  <p className="text-gray-600">Setting up your ESG insights...</p>
                </div>
              </div>
            )}

            <div className="bg-white rounded-2xl shadow-lg border border-gray-200">
              <LocationIndustrySelector onSelectionChange={handleSelectionChange} className="p-8" />
            </div>
          </div>
        </section>
      )}
      ...
      {/* CTA Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-600 to-blue-600 text-center text-white">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-3xl font-bold mb-4">Ready to Lead in Sustainability?</h2>
          <p className="text-xl text-green-100 mb-8">
            Join organizations driving impactful ESG transformations with Ploxi Earth.
          </p>
          <Link
            href="/corporate/register"
            className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold bg-white text-green-600 rounded-xl hover:bg-gray-50 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
          >
            Get Started Today
            <ArrowRight className="ml-3 h-5 w-5" />
          </Link>
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            />
            <span className="text-gray-300">© 2025 Ploxi Consult. All rights reserved.</span>
          </div>
